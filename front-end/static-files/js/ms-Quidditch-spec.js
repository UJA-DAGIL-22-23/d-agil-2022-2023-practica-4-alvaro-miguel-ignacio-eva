...
const elementoTituloQuidditch = document.getElementById(Frontend.ID_SECCION_PRINCIPAL_TITULO)
const elementoContenidoQuidditch = document.getElementById(Frontend.ID_SECCION_PRINCIPAL_CONTENIDO)
const TITULO_HOME_Quidditch = "Quidditch Home"
const TITULO_ACERCA_DE_Quidditch = "Quidditch Acerca de"
const LISTADO_IMPRIMIR_MUCHAS_PERSONAS_Quidditch = "Listado de personas con todos los datos "
const LISTADO_IMPRIMIR_MUCHAS_PERSONAS_ALFABETICAMENTE_Quidditch="Listado de personas ordenadas alfabeticamente solo con su nombre"
const CEREAR = "cerear"
const LISTADO_NOMBRE_MUCHAS_PERSONAS_Quidditch ="Listado de personas solo con su nombre"
const LISTADO_UNA_PERSONA_Quidditch="Mostrar una persona"
const LISTADO_NOMBRE_MUCHAS_PERSONAS_TODOS_DATOS_Quidditch = "Listado de personas ordenadas alfabeticamente con todos sus datos"


const datosDescargadosPrueba_Quidditch = {
...
const datosDescargadosPruebaPersona_Quidditch = {
    id: 1,
    nombre: "Harry",
    apellidos: "Potter",
    posicion: "buscador",
...
describe("Quidditch.mostrarHome: ", function () {
    ...
    it("muestra datos nulos cuando le pasamos un valor nulo",
        function () {
            ...
            expect(elementoTituloQuidditch.innerHTML).toBe(TITULO_HOME_Quidditch
            )
            expect(elementoContenidoQuidditch.innerHTML).toBe(Quidditch.datosDescargadosNulos.mensaje)
        })
    ...
    it("muestra correctamente el título y el mensaje",
        function () {
            Quidditch.mostrarHome(datosDescargadosPrueba_Quidditch)
            expect(elementoTituloQuidditch.innerHTML).toBe(TITULO_HOME_Quidditch
            )
            expect(elementoContenidoQuidditch.innerHTML).toBe(datosDescargadosPrueba_Quidditch.mensaje)
        })
})
...
describe("Quidditch.mostrarAcercaDe: ", function () {
    it("muestra datos nulos cuando le pasamos un valor nulo",
        function () {
            ...
            expect(elementoTituloQuidditch.innerHTML).toBe(TITULO_ACERCA_DE_Quidditch)
            expect(elementoContenidoQuidditch.innerHTML.search(Quidditch.datosDescargadosNulos.mensaje) >= 0).toBeTrue()
        })
    ...
    it("muestra datos nulos cuando le pasamos un objeto que no tiene campo mensaje o autor o email o fecha ",
        function () {
          ...
          expect(elementoTituloQuidditch.innerHTML).toBe(TITULO_ACERCA_DE_Quidditch)
           expect(elementoContenidoQuidditch.innerHTML.search(Quidditch.datosDescargadosNulos.mensaje) >= 0).toBeFalse()
    ...
    it("muestra correctamente el título y el mensaje conteniendo el autor, el email y la fecha",
        function () {
            Quidditch.mostrarAcercaDe(datosDescargadosPrueba_Quidditch)
            expect(elementoTituloQuidditch.innerHTML).toBe(TITULO_ACERCA_DE_Quidditch)

            // Comprobamos que al buscar el autor, el email y la fecha de prueba los encuentra dentro del contenido del article
          expect(elementoContenidoQuidditch.innerHTML.search(datosDescargadosPrueba_Quidditch.autor) >= 0).toBeTrue()
            expect(elementoContenidoQuidditch.innerHTML.search(datosDescargadosPrueba_Quidditch.email) >= 0).toBeTrue()
            expect(elementoContenidoQuidditch.innerHTML.search(datosDescargadosPrueba_Quidditch.fecha) >= 0).toBeTrue()
        })
...
describe("Quidditch.imprimeMuchasPersonas: ", function () {
    it("muestra datos nulos cuando le pasamos un valor nulo",
        function () {
            ...
            expect(elementoTituloQuidditch.innerHTML).toBe(LISTADO_IMPRIMIR_MUCHAS_PERSONAS_Quidditch)
...
describe("Quidditch.imprimeOrdenadorAlfabeticamente: ", function (){
    it("muestra datos nulos cuando le pasamos un valor nulo",
        function () {
            ...
            expect(elementoTituloQuidditch.innerHTML).toBe(LISTADO_IMPRIMIR_MUCHAS_PERSONAS_ALFABETICAMENTE_Quidditch)
...
describe("Quidditch.imprimeNombreMuchasPersonas: ", function (){
    it("muestra datos nulos cuando le pasamos un valor nulo",
        function () {
            ...
            expect(elementoTituloQuidditch.innerHTML).toBe(LISTADO_NOMBRE_MUCHAS_PERSONAS_Quidditch)
...
describe("Quidditch.imprimeOrdenadorAlfabeticamenteTodosCampos", function() {
        it("muestra datos nulos cuando le pasamos un valor nulo",
            function () {
                ...
                expect(elementoTituloQuidditch.innerHTML).toBe(LISTADO_NOMBRE_MUCHAS_PERSONAS_TODOS_DATOS_Quidditch)
